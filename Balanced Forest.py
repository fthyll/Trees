...
def best_split(root, target, exclude=None, path=None):
    ...
    # If current tree's cost is more than two times of target cost,
    # then you need to insert negative value in order to balance
    # them, which is not valid for our task.
